        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="edicaMainNav">
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                    ...
                    @auth
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('personal.main.index') }}">Personal аrea <span
                    ...
                    @can('view', auth()->user())
                        <li class="nav-item active">
                            <a class="nav-link" href="{{ route('admin.main.index') }}">Admin <span class="sr-only">(current)</span></a>
                        </li>
                    @endcan
                    ...
                    <li class="nav-item">
                        <form action="{{route('post.index')}}" method="get">
                            <div class="input-group">
                                <input type="search" class="form-control rounded border" placeholder="Search" aria-label="Search" aria-describedby="search-addon" />
